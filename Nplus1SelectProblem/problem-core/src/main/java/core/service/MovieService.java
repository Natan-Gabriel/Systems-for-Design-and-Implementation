...
public class MovieService {
    ...
    public List<Movie> getMovieClients(long clientId){
        return movieRepository.findAllByIdWithRentalsAndClientSQL(clientId);
        //return movieRepository.findAllByIdWithRentalsAndClientCriteriaAPI(clientId);
        //return movieRepository.findAllByIdWithRentalsAndClientJPQL(clientId);
    }
    public List<Movie> getMoviesWithRentalsAndClients()
    {
        return movieRepository.findAllWithRentalsAndClientSQL();
        //return movieRepository.findAllWithRentalsAndClientCriteriaAPI();
        //return movieRepository.findAllWithRentalsAndClientJPQL();
    }

    public List<Movie> findDistinctByName(String name){
        return movieRepository.findDistinctByName(name);
    }
    public List<Movie> findDistinctBySerial(String name){
        return movieRepository.findDistinctBySerial(name);
    }
